...
export default function SiteFooter({ branding }: SiteFooterProps) {
  ...
  const hours = branding?.openingHours || "Open Daily: 8:00 AM – 7:00 PM";
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-slate-200">
        <div className="space-y-4 md:col-span-1">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="font-black text-slate-900 text-base block">{siteName}</span>
            </div>
          </div>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2.5 font-medium">
            <li>
              <Link href="/services/digital-photo-studio" className="hover:text-rose-600">Passport & Visa Photos (10 mins)</Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/services/visiting-cards" className="hover:text-rose-600">Business Cards (300 GSM)</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2.5 text-slate-600 font-medium">
            ...
            <div className="flex items-center gap-2 text-slate-700">
              <Clock3 className="w-4 h-4 text-rose-500 shrink-0" />
              <span>{hours}</span>
            </div>
          </div>
        </div>
