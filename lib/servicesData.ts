...
export const SERVICES_CATALOG: ServiceCategory[] = [
  ...
  },
  {
    ...
    name: "Events",
    slug: "events",
    description: "Event admission tickets, award ribbon badges, X-stands, roll-up banners & screen printed ceremonial khada.",
    iconName: "Calendar",
    ...
    subcategories: [
        ...
        products: [
          {
            ...
            description: "Single sided concert/event ticket with perforation stub line and serial numbering.",
            paperSpec: "170 GSM Art Card + Perforation",
          },
          {
            id: "ticket-standard-both-side",
            name: "Ticket Standard Both Side",
            slug: "ticket-standard-both-side",
            description: "Double sided event ticket with sponsor branding and security barcode.",
            paperSpec: "250 GSM Matte Card",
          },
        ],
      },
      {
        ...
        products: [
          {
            id: "1-ring-ribbon-badge",
            name: "1 Ring Ribbon Badge",
            slug: "1-ring-ribbon-badge",
            description: "Single ring satin award rosette ribbon badge with custom printed center button.",
            paperSpec: "Satin Ribbon Rosette",
          },
          {
            id: "2-ring-ribbon-badge",
            name: "2 Ring Ribbon Badge",
            slug: "2-ring-ribbon-badge",
            description: "Deluxe double ring satin ceremony rosette badge.",
            paperSpec: "Dual Satin Ribbon Rosette",
          },
        ],
      },
      {
        ...
        products: [
          {
            id: "normal-x-stand",
            name: "Normal X Stand 2'x5'",
            slug: "normal-x-stand-2x5",
            description: "2x5 feet portable fiberglass X-frame banner stand with printed flex banner.",
            paperSpec: "Star Flex Banner + X Stand Frame",
          },
          {
            id: "medium-x-stand",
            name: "Medium X Stand 2'x5'",
            slug: "medium-x-stand-2x5",
            description: "Heavy duty metal-joint X-stand display banner.",
            paperSpec: "Star Flex Banner + Reinforced Frame",
          },
          {
            id: "roll-up-standee",
            name: "Roll Up Stand 30\"x78\"",
            slug: "roll-up-stand-30x78",
            description: "30x78 inch retractable aluminum pull-up banner stand with carrying bag.",
            paperSpec: "PP Synthetic Film + Aluminum Rollup Base",
          },
        ],
      },
      {
        ...
        products: [
          {
            id: "khada-screen-print",
            name: "Khada 8\" Wide - Single Color Screen Print",
            slug: "khada-8-wide-single-color-screen-print",
            description: "8 inch wide traditional silk ceremonial khada scarf with custom screen printed logo/text.",
            paperSpec: "Silk Scarf + Screen Print Ink",
          },
        ],
      },
    ],
